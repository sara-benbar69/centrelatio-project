...
const faqs = [
  'Comment centraliser mes conversations WhatsApp ?',
  'Centrelatio fonctionne-t-il sans application client ?',
  'Puis-je connecter mon équipe au même compte ?',
  'Comment suivre les demandes et les réclamations ?',
  'La solution est-elle adaptee aux institutions ?',
